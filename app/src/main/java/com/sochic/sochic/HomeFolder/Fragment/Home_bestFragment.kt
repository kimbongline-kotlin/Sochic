...
import kotlinx.android.synthetic.main.fragment_home_best.gridLayer
import kotlinx.android.synthetic.main.fragment_home_best.recycler
...
class Home_bestFragment : Fragment() {
    ...
    fun getItem(){
        kAct.disposable.add(kAct.apiService.BEST_ITEM_API(kAct.id_user)
            .subscribeOn(kAct.io)
