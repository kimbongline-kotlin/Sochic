...
import kotlinx.android.synthetic.main.fragment_home_best.*
import kotlinx.android.synthetic.main.fragment_home_follow.*
import kotlinx.android.synthetic.main.fragment_home_follow.gridLayer
import kotlinx.android.synthetic.main.fragment_home_follow.recycler
 ...
 *
 */
class Home_followFragment : Fragment() {
    ...
    fun getItem(){
        kAct.disposable.add(kAct.apiService.FOLLOW_ITEM_API(kAct.id_user)
            .subscribeOn(kAct.io)
