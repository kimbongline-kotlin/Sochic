...
import kotlinx.android.synthetic.main.fragment_home_open.gridLayer
import kotlinx.android.synthetic.main.fragment_home_open.recycler
 ...
 *
 */
class Home_openFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_home_open, container, false)
    }
    ...
    fun getItem(){
        kAct.disposable.add(kAct.apiService.OPEN_ITEM_API(kAct.id_user)
            .subscribeOn(kAct.io)
