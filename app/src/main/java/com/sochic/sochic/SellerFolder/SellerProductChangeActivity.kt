...
import kotlinx.android.synthetic.main.activity_seller_product_change.*


class SellerProductChangeActivity : ScActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_seller_product_change)
    ...
    fun getItem() {
        disposable.add(apiService.SELLER_ORDER_LIST_API(id_user,dSpinner.selectedItemPosition,1)
            .subscribeOn(io)
            .observeOn(thread)
            .subscribeWith(object : DisposableSingleObserver<OrderAPI>() {
                ...
                override fun onSuccess(t: OrderAPI) {
                    ...
                    var adapter = SellerOrderAdapter(applicationContext,this@SellerProductChangeActivity,tempData)
